...
class BootState extends Phaser.State {
    ...
    preload() {
        ...
        this.game.load.image('map-type-button', 'assets/fullscreen-button.png')
        ...
        this.game.load.tilemap('level-free1', 'assets/level-free1.json', null, Phaser.Tilemap.TILED_JSON)
    }
