...
class Player extends Phaser.Sprite {
    ...
    onVStick(direction, distance, angle) {
        this.moveVStick.x = direction.x
        this.moveVStick.y = direction.y
    }
    ...
    moveByKeys() {
        ...
        // virtual joystick
        this.move.x += this.game.vstick.direction.x
        this.move.y += this.game.vstick.direction.y
