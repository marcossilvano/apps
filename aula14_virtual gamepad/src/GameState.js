...
class GameState extends BaseState {
    ...
    create() {
        ...
        this.game.vstick = new VirtualJoystick(this.game, 
            100, this.game.height-100, 'vstick_thumb', 'vstick_base', 30)
        this.game.add.existing(this.game.vstick)
        this.game.vstick.addVirtualButton(
            this.game.width-100, this.game.height-100, 'vstick_button', 
            () => this.player1.cursors.fire.isDown = true, 
            () => this.player1.cursors.fire.isDown = false)
   }
